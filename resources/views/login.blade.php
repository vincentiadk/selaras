...
<html lang="en">
  <head>
    ...
    <title>Selaras Administrator Login </title>
    ...
    <!-- Animate.css -->
    <link href="{{ asset('/tempadmin/assets/animate.css/animate.min.css') }}" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="{{ asset('/tempadmin/css/custom.min.css') }}" rel="stylesheet">
  </head>
          ...
          <section class="login_content">
            <form method="POST" action="/login">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Selaras Consulting</h1>
